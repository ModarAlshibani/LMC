...
import 'package:lmc_app/features/student_features/lessons_management/self_test/selftests_list/ui/widgets/stu_selftest_outside.dart';
...
class StuSelfTestsList extends StatelessWidget {
  final int lessonId;

  const StuSelfTestsList({super.key, required this.lessonId});
  @override
        ...
        if (state is SelfTestsLoading) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              return StuSelfTestsOutside(selfTest: SelfTests[index]);
            },
          );
        }
        return StateWidgets.buildEmptyState();
