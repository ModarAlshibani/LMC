...
class TrueFalseQuestionForm extends StatefulWidget {
  final SelfTests selfTest;
  TrueFalseQuestionForm({Key? key, required this.selfTest}) : super(key: key);

  @override
  State<TrueFalseQuestionForm> createState() => _TrueFalseQuestionFormState();
}

class _TrueFalseQuestionFormState extends State<TrueFalseQuestionForm> {
