...
import 'package:lmc_app/features/student_features/lessons_management/self_test/self_test_details/ui/widgets/stu_question_viewer.dart';
...
class StuSelfTestDetails extends StatefulWidget {
  final SelfTests selfTest;
  const StuSelfTestDetails({super.key, required this.selfTest});

  @override
  State<StuSelfTestDetails> createState() => _StuSelfTestDetailsState();
}

class _StuSelfTestDetailsState extends State<StuSelfTestDetails> {
  int currentIndex = 0;
                        ...
                        child: Container(
                          ...
                          child:
                              questions.isEmpty
                                  ? Center(
                                    child: Text(
                                          "There is No Questions added yet",
                                          style: TextStyle(
                                            fontSize: 18.sp,
